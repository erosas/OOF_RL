...
| MMR timeout hardening | `/api/tracker/profile` lookups are bounded by a 15-second context and provider delays are cancelable. | Run History/Ranks responsiveness smoke against real MMR lookups before tag. |
