...
const previewRoute = "/internal/momentum-timeline-preview"

// Plugin serves a hidden fixture-only Momentum Timeline preview page.
// It has no nav tab, event subscriptions, persistence, or live data wiring.
type Plugin struct {
	plugin.BasePlugin
}
...
func (p *Plugin) ID() string         { return "momentum-timeline-preview" }
