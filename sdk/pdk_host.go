...
func HTTPDownload(_ HTTPDownloadRequest) HTTPDownloadResult          { return HTTPDownloadResult{} }
func UploadFile(_, _, _ string, _ map[string]string) HTTPFetchResult { return HTTPFetchResult{} }
